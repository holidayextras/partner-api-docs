...
| lang                   | String    | [A-Z] 2 chars      | Y*         | For European products, sets the language of the booking. (the default is `de`, other values available are `en`, `fr`, `it`, `es`, `pt`, `pl` and `nl`.)                                                                                                                                                                                                                                                                                                                                                      |
