...
| lang            | String    | [A-Z] 2 chars     | Y*         | Sets the language of the booking. (the default is `en` for UK bookings and `de` for EU bookings, other values available are `fr`, `it`, `es`, `pt`, `pl` and `nl`.)                                                                                                                                                                                                                                                                                                                                              |
